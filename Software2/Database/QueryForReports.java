...
public class QueryForReports extends Appointments {

    public QueryForReports(int appointmentID, String appointmentTitle, String appointmentDescription, String appointmentLocation, String appointmentType, LocalDateTime start, LocalDateTime end, int customerID, int userID, int contactID) {
    ...
    /**
     *  Query that pulls the exact data requested
     * @throws SQLException
