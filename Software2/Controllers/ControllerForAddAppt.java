...
import Database.QueryForAppointment;
import Database.QueryForContacts;
import Database.QueryForCustomer;
import Database.QueryForUsers;
 ...
 */
public class ControllerForAddAppt {
    ...
    /**
     * Initialize controls and the fill start and end time boxes to show in 15 minutes increments.
...
//                            (dateTimeEnd.isEqual(checkEnd) || dateTimeEnd.isBefore(checkEnd)))
                ...
                ps.setInt(13, Integer.parseInt(QueryForContacts.findContactID(addAppointmentContact.getValue())));
                ps.setInt(14, Integer.parseInt(QueryForContacts.findContactID(addAppointmentUserID.getText())));
