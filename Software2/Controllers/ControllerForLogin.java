...
public class ControllerForLogin implements Initializable {
    ...
    private void loginButton(ActionEvent event) throws SQLException, IOException, Exception {
        try {
            ...
            int userId = QueryForUsers.validateUser(usernameInput, passwordInput);
            ...
            if (userId > 0) {
                ...
                loader.setLocation(getClass().getResource("/views/MainScene.fxml"));
                ...
                if (appointmentWithin15Min !=false) {
                    Alert alert = new Alert(Alert.AlertType.CONFIRMATION, "There's an appointment within 15 minutes: " + getAppointmentID + " with the appointment start time of: " + displayTime);
    ...
    /**
     * Initiliaze with screen start. Get locale info and set text on fields.
     * @param url, rb
     */
