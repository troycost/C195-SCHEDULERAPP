...
import static main.TimeUtility.convertTimeDateUTC;
...
public class ControllerForApptMain {
    ...
    public void initialize() throws SQLException {
        ...
        ObservableList<Appointments> allAppointmentsList = QueryForAppointment.getAllAppointments();
    ...
    /**
     * Open AddAppointment.fxml upon clicking the add button.
     * @param event
     * @throws IOException
     */
    @FXML
    void addAppointment(ActionEvent event) throws IOException {
        ...
        Parent addParts = FXMLLoader.load(getClass().getResource("../views/AddAppointment.fxml"));
    ...
    void deleteAppointment(ActionEvent event) throws Exception {
        try {
            ...
            String deleteAppointmentType = allAppointmentsTable.getSelectionModel().getSelectedItem().getTypeOfAppointment();
            ...
            if (confirmation.isPresent() && confirmation.get() == ButtonType.OK) {
                QueryForAppointment.deleteAppointment(deleteAppointmentID, connection);
    ...
    /**
     * Load appointment data when button is pressed.
     * Lambda #3 to fill the AllNamesOfContacts observable list with contact information.
     */
    @FXML
    void loadAppointment() {
        try {
            ...
            if (selectedAppointment != null) {
                ...
                ObservableList<String> AllNamesOfContacts = FXCollections.observableArrayList();
                String displayContactName = "";

                //lambda #3
                contactsObservableList.forEach(contacts -> AllNamesOfContacts.add(contacts.getContactName()));
                addAppointmentContact.setItems(AllNamesOfContacts);
                ...
                updateAppointmentTitle.setText(selectedAppointment.getTitleForAppointment());
                addAppointmentDescription.setText(selectedAppointment.getDescriptionForAppointment());
                addAppointmentLocation.setText(selectedAppointment.getLocationForAppointment());
                addAppointmentType.setText(selectedAppointment.getTypeOfAppointment());
    ...
    void saveAppointment(ActionEvent event) {
        try {
            ...
            {
                ObservableList<Customers> getAllCustomers = QueryForCustomer.getAllCustomers(connection);
                ObservableList<Integer> storeCustomerIDs = FXCollections.observableArrayList();
                ObservableList<QueryForUsers> getAllUsers = QueryForUsers.getAllUsers();
...
//                            (dateTimeEnd.isEqual(checkEnd) || dateTimeEnd.isBefore(checkEnd)))
                ...
                ps.setInt(12, Integer.parseInt(QueryForContacts.findContactID(addAppointmentContact.getValue())));
